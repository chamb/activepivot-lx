...
public class CreateDatabase {
	...
	/** Logger */
	static final Logger LOG = Logger.getLogger(CreateDatabase.class.getName());
	
	// JDBC driver
	static final String JDBC_DRIVER = "com.leanxcale.jdbc.ElasticDriver";
	
	// Connection string
	static final String DB_URL = "jdbc:leanxcale:direct://localhost:1529/db;create=true";
	...
	public static void main(String[] args) throws Exception {
	    ...
	    try(Connection conn = DriverManager.getConnection(DB_URL,USER,PASS);
			...
			System.out.println(createRiskTable);
